...
define('kitchens-international/tests/models/project', ['exports', 'ember-data-contentful/models/contentful', 'ember-data/attr'], function (exports, _emberDataContentfulModelsContentful, _emberDataAttr) {
    'use strict';
...
define('kitchens-international/tests/routes/commerical', ['exports', 'ember'], function (exports, _ember) {
  'use strict';

  exports['default'] = _ember['default'].Route.extend({});
});
define('kitchens-international/tests/routes/commerical.jshint', ['exports'], function (exports) {
  'use strict';

  QUnit.module('JSHint | routes/commerical.js');
  QUnit.test('should pass jshint', function (assert) {
    assert.expect(1);
    assert.ok(true, 'routes/commerical.js should pass jshint.');
  });
});
...
define('kitchens-international/tests/routes/projects.jshint', ['exports'], function (exports) {
  ...
  QUnit.test('should pass jshint', function (assert) {
    assert.expect(1);
    assert.ok(false, 'routes/projects.js should pass jshint.\nroutes/projects.js: line 4, col 12, \'params\' is defined but never used.\n\n1 error');
  });
});
...
define('kitchens-international/tests/serializers/application.jshint', ['exports'], function (exports) {
  ...
  QUnit.test('should pass jshint', function (assert) {
    assert.expect(1);
    assert.ok(false, 'serializers/application.js should pass jshint.\nserializers/application.js: line 35, col 36, The array literal notation [] is preferable.\nserializers/application.js: line 36, col 35, The array literal notation [] is preferable.\n\n2 errors');
  });
});
...
define('kitchens-international/tests/unit/routes/commerical-test', ['exports', 'ember-qunit'], function (exports, _emberQunit) {
  'use strict';

  (0, _emberQunit.moduleFor)('route:commerical', 'Unit | Route | commerical', {
    // Specify the other units that are required for this test.
    // needs: ['controller:foo']
  });
...
define('kitchens-international/tests/unit/routes/commerical-test.jshint', ['exports'], function (exports) {
  'use strict';

  QUnit.module('JSHint | unit/routes/commerical-test.js');
  QUnit.test('should pass jshint', function (assert) {
    assert.expect(1);
    assert.ok(true, 'unit/routes/commerical-test.js should pass jshint.');
  });
});
