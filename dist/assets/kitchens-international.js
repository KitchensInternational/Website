  ...
  exports["default"] = Ember.HTMLBars.template((function () {
    return {
      ...
      buildFragment: function buildFragment(dom) {
        ...
        dom.setAttribute(el5, "class", "btn btn-outline-secondary mt-4");
        var el6 = dom.createTextNode("Request a consultation");
  ...
  exports["default"] = Ember.HTMLBars.template((function () {
    ...
    return {
      ...
      buildFragment: function buildFragment(dom) {
        ...
        dom.setAttribute(el6, "class", "col-10 text-white text-center py-4");
...
if (!runningTests) {
  require("kitchens-international/app")["default"].create({"name":"kitchens-international","version":"1.0.0+64a69007"});
}
